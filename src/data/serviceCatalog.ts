...
export type FormatId = 'landscape' | 'portrait' | 'dual' | 'square' | 'source';
...
const SQUARE: ServiceFormat = { id: 'square', name: '1:1 方版' };
const SOURCE: ServiceFormat = { id: 'source', name: '跟随原素材' };
...
export const SERVICE_CATALOG: ServiceDefinition[] = [
  {
    ...
    materialHint: '提供产品图片、商品链接和资料地址。',
    duration: '标准版/创意版 30 秒以内，定制版 45-60 秒',
    priceLabel: '80 USD 起',
  ...
  },
  {
    ...
    name: '产品 AI 精品广告',
    shortName: 'AI 精品广告',
    summary: '以完整创意概念、分镜和精细制作建立重点产品或品牌记忆点。',
    materialHint: '提供项目目标、品牌资料、产品清单和参考方向。',
    duration: '30-60 秒',
    priceLabel: '350 USD / 项目',
    formats: [LANDSCAPE, PORTRAIT],
    supportsMultipleSku: true,
  },
  {
    id: 'installation',
    legacyId: 'vt_02',
  ...
  },
  {
    ...
    duration: '基础修改跟随原素材，常规混剪 60 秒以内',
    priceLabel: '5 USD 起',
    formats: [SOURCE, LANDSCAPE, PORTRAIT, SQUARE],
  },
  {
    id: 'custom',
    legacyId: 'vt_07',
    ...
    materialHint: '提供项目描述、品牌资料、参考作品和期望完成时间。',
    duration: '按项目确认',
    priceLabel: '确认后报价',
    formats: [],
    customQuote: true,
