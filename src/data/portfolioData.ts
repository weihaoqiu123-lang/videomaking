...
const work = (
  value: Omit<PortfolioItem, 'videoTypeId' | 'thumbnail' | 'image'> & { image: string },
): PortfolioItem => ({
  ...value,
...
const premiumWorks = [
  work({ id: 'premium_01', title: 'Quiet Frequency', productName: '旗舰头戴降噪耳机', sku: 'HP-9000', serviceId: 'ai_premium', videoTypeName: '产品 AI 精品广告', creatorId: 'vp_wangmin', creatorName: '王敏', duration: '52 秒', image: images.phone, description: '以声音空间和材质微距建立高端产品记忆。', aspectRatio: '16:9' }),
  work({ id: 'premium_02', title: 'Home in Motion', productName: '智能家居组合', sku: 'HOME-26', serviceId: 'ai_premium', videoTypeName: '产品 AI 精品广告', creatorId: 'vp_zhaoqi', creatorName: '赵琪', duration: '58 秒', image: images.interior, description: '多产品组合串联回家、休息和离家场景。', aspectRatio: '16:9' }),
  work({ id: 'premium_03', title: 'Above the City', productName: '碳纤维折叠滑板车', sku: 'SCOOT-01', serviceId: 'ai_premium', videoTypeName: '产品 AI 精品广告', creatorId: 'vp_liuwei', creatorName: '刘伟', duration: '49 秒', image: images.studio, description: '用城市建筑和速度意象强化轻量科技感。', aspectRatio: '16:9' }),
];
...
export const portfolioSections: PortfolioSection[] = [
  ...
  { serviceId: 'ai_premium', title: '产品 AI 精品广告', shortTitle: 'AI 精品广告', intro: '为重点产品和品牌项目提供完整创意、分镜和精细制作。', price: '350 USD / 项目', duration: '30-60 秒', works: premiumWorks },
